...
| [Robinhood Portfolio Manager]({{ '/en/skills/robinhood-portfolio-manager/' | relative_url }}) | Comprehensive portfolio analysis using Robinhood MCP Server integration to fetch holdings and positions, then analyze... | <span class="badge badge-api">Robinhood Required</span> |
...
| [Trading Desk Operator]({{ '/en/skills/trading-desk-operator/' | relative_url }}) | Run a disciplined, risk-first equities trading desk over a Robinhood (MCP) book and watchlist, posting a clean briefi... | <span class="badge badge-api">Robinhood Required</span> |
