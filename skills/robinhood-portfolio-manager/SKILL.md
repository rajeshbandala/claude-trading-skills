...
Use get_equity_positions / get_portfolio to confirm sufficient shares (sell) or buying power (buy).
Use get_equity_orders to check for conflicting open orders on the same symbol.
```
